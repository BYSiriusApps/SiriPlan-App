...
export default function GirisPage() {
  ...
  async function handleMagicLink() {
    ...
    if (error) {
      ...
      toast.success("Magic link e-postanıza gönderildi! 📬");
    }
    ...
    <Card className="shadow-xl border-0 bg-card/80 backdrop-blur-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="relative">
          <Separator />
          <span className="absolute left-1/2 -translate-x-1/2 -top-3 bg-card px-2 text-xs text-muted-foreground">veya</span>
        </div>
        ...
        >
          {magicLoading ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> : null}
